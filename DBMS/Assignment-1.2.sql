...
Ans:
select title,name ,rental_duration , count(rental_duration) from film,category where category_id=11 group by rental_duration order by rental_duration desc limit 3 ; 
